...
app.put('/documents', (req: any, res: any) => {
...
app.get('/documents/:documentId', async (req: any, res: any) => {
...
app.post('/documents/:documentId', (req: any, res: any) => {
  if (req.params && req.params.documentId) {
    const { documentId } = req.params;
...
app.delete('/notes/:notesId', (req: any, res: any) => {
...
app.put('/notes/:notesId', (req: any, res: any) => {
  try {
    if (req.params && req.params.notesId) {
      const { notesId } = req.params;
...
app.get('/documents', asyncWrapper(fetchRecords));

app.get('/tags', asyncWrapper(fetchTags));

app.get('/notes', asyncWrapper(fetchNotes));
